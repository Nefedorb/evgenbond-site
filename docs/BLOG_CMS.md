...
- Изображения для новых статей оптимизируются вручную до загрузки в CMS.
- Рекомендуемый предел — 1600 px по длинной стороне и около 300 КБ на файл.
- Для фотографий предпочтительны WebP или качественно сжатый JPEG.
- Не увеличивать маленькие исходники: это повышает вес, но не добавляет детализации.
